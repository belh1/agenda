...
export class ContatoService {
  ...
  constructor() {
    let contato = new Contato("Teste", 123,"masculino","2022-08-10");
  ...
  public editar(contato: Contato, nome:string, telefone: number, genero: string, data_nacimento:string): boolean{
